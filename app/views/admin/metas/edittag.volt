...
<div class="row">
        ...
        <form method="post" id="mergeTags">
            <div class="panel">
                ...
                <span class="btn btn-sm btn-outline btn-labeled btn-warning">
                    ...
                    {% if tagg.count == 0 %}
                    <a href="{{ url('yzoi7x/metas/removetag/'~tagg.id) }}" class="label"><i class="fa fa-remove"></i></a>
                    {% endif %}
                </span>
                    {% endfor %}
                </div>
    ...
    <div class="col-sm-4">
        <div class="panel">
            ...
            <div class="panel-heading">
                <span class="panel-title"><i class="fa fa-th"></i> 编辑标签</span>
            </div>
