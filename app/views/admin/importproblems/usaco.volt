            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <p class="help-block">如：http://www.usaco.org/index.php?page=viewproblem2&cpid=[*]</p>
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="sample_input">通配符的值，支持减号“<span class="text-danger">-</span>”，表示起止值，也支持逗号；用“<span class="text-danger">|</span>”分段来源</label>
                        <input type="text" name="theval" class="form-control">
                        <p class="help-block">若填写999，则上述地址会解析为http://www.usaco.org/index.php?page=viewproblem2&cpid=999</p>
                    </div>
                    <div class="form-group">
